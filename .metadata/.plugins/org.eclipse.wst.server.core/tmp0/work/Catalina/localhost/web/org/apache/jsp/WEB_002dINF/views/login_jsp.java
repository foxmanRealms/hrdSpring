 ...
 * Generated at: 2022-04-21 00:30:53 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<div class=\"panel-heading\">Login Select</div>\r\n");
      out.write("\t\t\t<div class=\"panel-body\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<form class=\"form-horizontal\" method=\"post\" action=\"loginSelect.do\">\r\n");
      out.write("\t\t\t\t\t<table style=\"width:400px; text-align:center; margin:auto;\" class=\"table table-hover table-bordered\">\r\n");
      out.write("\t\t\t\t\t\t<!--로그인 버튼을 누르면 loginSelect.do라는 곳으로 id와 pw가 넘어간다\r\n");
      out.write("\t\t\t\t\t\t  loginSelect.do를 요청했을 때 해당하는 id와 pw가 일치하는 회원을 찾았다면\r\n");
      out.write("\t\t\t\t\t\t  해당 회원의 id,pw,nick,phone 정보를 session에 담아 boardList.jsp로 이동\r\n");
      out.write("\t\t\t\t\t\t  -->\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>아이디</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input name=\"id\" class=\"form-control\" type=\"text\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>비밀번호</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input name=\"pw\"  class=\"form-control\" type=\"password\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"2\">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"join.do\">아직 회원이 아니시면 여기를 클릭해주세요.</a> <br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"reset\" class=\"btn btn-success btn-sm\">취소</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-info btn-sm\">로그인</button></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\r\n");
